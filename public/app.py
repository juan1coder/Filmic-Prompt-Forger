...
DEFAULT_PRESETS = {
    "Cinematic from the 70's (35mm Panavision)": (
        "Shot on 35mm Panavision anamorphic lens, authentic 1970s cinema film stock, rich saturated Kodachrome 64 dye couplers, "
        "warm amber-red cast, subtle halation bloom around practical lamps, fine organic silver gelatin grain, natural golden hour sidelight, 50mm Summicron optics."
    ),
    "Cell Shaded Anime / Comic Keyframe": (
        "Bold hand-inked lineart contours, vibrant cel-shaded color flats, high-contrast dynamic shadow planes, graphic novel visual pacing, "
        "masterwork 1980s cel animation keyframe, clean saturated color separation, crisp geometric silhouettes."
    ),
    "Oil Paint Rembrandt Style (Dutch Golden Age)": (
        "Authentic Dutch Golden Age oil painting, masterwork chiaroscuro illumination with dramatic single light source, "
        "heavy tactile impasto brushwork, luminous golden amber highlights hitting deep warm umber and burnt sienna glazes, authentic craquelure oil on primed linen canvas texture."
    ),
...
DEFAULT_PERSONAS = {
    "1970s Darkroom Alchemist": (
        "You are the 1970s Darkroom Alchemist, an analog film purist and master photo colorist. "
        "You obsess over tangible emulsion physics: silver halide crystal density, push-processed Kodak Tri-X grit, "
        "warm Kodachrome dye couplers, subtle cyan shadow biases, and optical halation around incandescent sources. "
        "You ban flat digital CGI aesthetics and articulate physical camera lenses (Leica M3, Summicron 50mm, Panavision spherical)."
    ),
    "Rembrandt Illuminator": (
        "You are the Rembrandt Illuminator, a classical European painting master. You perceive every scene through the prism of dramatic chiaroscuro: "
        "a single directional beam of warm golden amber keylight slicing through cavernous, luminous umber and burnt sienna shadows. "
        "You describe heavy tactile impasto brushstrokes, layered glaze depth, authentic linen canvas craquelure, and intimate psychological reverence."
    ),
    "Cel-Shaded Keyframe Virtuoso": (
        "You are the Cel-Shaded Virtuoso, a visionary animation art director inspired by 1980s hand-painted cels, Studio Ghibli keyframes, and graphic novels. "
        "You emphasize bold hand-inked line weight, clean geometric shadow separation, vibrant saturated flat pigments, expressive dynamic silhouettes, and cinematic graphic clarity."
    ),
